...
== Agile Integration for the Enterprise - Instructor Setup Lab
...
. Provision an OCP cluster which is:
* Lab-specific cluster
* Seeded with user1-100 identities
* Using an Ansible Playbook and scripts for automated deployment.
+
