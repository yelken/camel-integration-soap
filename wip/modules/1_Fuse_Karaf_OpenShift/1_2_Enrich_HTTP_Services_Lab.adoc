...
. Download the `Enrich-content-REST-and-WS-microservices` lab assets.

. Import the `Enrich-content-REST-and-WS-microservices` lab assets that you have downloaded, into a new Red Hat CodeReady Studio workspace. You will find 3 projects:
...
. The REST service should be running on port 8080, and can be accessed through URL: http://localhost:8080/rest/customerservice/enrich
...
. The Camel service should be running on port 9090, and can be accessed through URL: http://localhost:9090/ws/customerService
...
You can access the H2 console by opening the URL: http://localhost:8080/h2-console. Please enter the JDBC URL as *jdbc:h2:mem:testdb* and log in.
