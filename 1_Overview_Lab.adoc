...
TODO: Insert Screenshot of OpenShift Console
...
. Login to OpenShift Container Platform as user `user1` with the provided password.
+
----
$ oc login https://${OPENSHIFT_API} -u user1
----
