...
[.text-center]
image:icons/icon-previous.png[align=left, width=128, link=2c_Integration_Application.adoc] image:images/icons/icon-home.png[align="center",width=128, link=README.md] image:icons/icon-next.png[align="right"width=128, link=3_Fuse_Online_Enrich_Lab.adoc]