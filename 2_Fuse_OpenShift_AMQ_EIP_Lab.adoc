...
+
[NOTE]
Check the box next to the project you intend to import, and click *Finish* to begin the import process for that project. Repeat for the remainder of the projects.
+
