...
+
----
oc logs -f pods/<pod name> -n business-services
----
...
. View the logs to make sure the Camel routes processed the message.
+
----
$ oc logs -f pods/amq-enrich-persist-lab-1-ttd89 -n business-services
----
...
.. Retrieve the name of the Postres database pod
+
----
$ oc get pods -n enterprise-services | grep postgresql
----

.. Access the Postgres database pod
+
----
$ oc -n enterprise-services rsh <pod name>
----
